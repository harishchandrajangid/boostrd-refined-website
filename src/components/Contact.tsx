...
const FORM_URL = 'https://docs.google.com/forms/d/e/XXXXXXXXXXXX/viewform?embedded=true'; // <-- replace
  ...
  return (
    <section id="contact" className="section-premium bg-[var(--gradient-hero)] text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute top-1/4 left-1/4 w-2 h-2 bg-primary-light rounded-full animate-float opacity-60" />
        <div
          className="absolute top-1/3 right-1/3 w-1 h-1 bg-white rounded-full animate-float opacity-40"
          style={{ animationDelay: '2s' }}
        />
        <div
          className="absolute bottom-1/3 left-1/2 w-3 h-3 bg-primary-light/50 rounded-full animate-float"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-8 sm:mb-16">
          ...
          <p className="text-xl text-foreground/80 max-w-3xl mx-auto leading-relaxed mb-6">
          ...
          {/* ---- NEW: Free Assessment Popup Button ---- */}
          <Dialog>
            ...
            <DialogContent className="max-w-3xl w-[95vw] h-[80vh] bg-white p-0 overflow-hidden">
              <DialogHeader className="sr-only">
                <DialogTitle>Free R&amp;D Assessment</DialogTitle>
                <DialogDescription>Fill out the form to get started.</DialogDescription>
              </DialogHeader>
              <iframe
                src={FORM_URL}
                title="Free R&D Assessment Form"
